...
if __name__ == "__main__":
    ...
    data = sc.textFile("/Users/jiayangan/project/SearchAds/data/log/ctr_features_demo/part*")
    ...
    # Save and load model
    model.save(sc, "/Users/jiayangan/project/SearchAds/data/model/ctr_logistic_model_demo13")
    # $example off$
